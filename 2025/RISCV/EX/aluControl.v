...
module aluControl#(
   ...
   // Inputs & Outputs:
(  input  [N_OPCODE-1:0]  i_funct, // instrucci�n[5-0] - 6bits
   input  [N_OPCODE-1:0]  i_op,    // instrucci�n[31-26] - 6bits
   input  [N_ALUOP-1:0] i_aluOp, // se�al de control - 2bits
   
   output reg [N_OPCODE-1:0] o_opcodeAlu
);
   ...
   always@(*) begin
      ...
      begin
         case(i_op) // Se leen los datos de instruccion[31:26] -> OP
            ...
            default: o_opcodeAlu = {N_OPCODE{1'b1}};  // Invalid input for the ALU
         endcase
      end
      ////////////////////////////////////////
      2'b01: // Branch equal
      begin
         case(i_op)
            6'b000100,
            6'b000101: o_opcodeAlu = {N_OPCODE{1'b1}}; // Invalid input for the ALU
         endcase
      end
      ////////////////////////////////////////
      2'b10: // R-Type
      begin
         case(i_funct) // Se leen los datos de instruccion[6:0] -> FUNCT
            ...
            6'b001000: o_opcodeAlu = {N_OPCODE{1'b1}}; // JR -> Invalid input for the ALU
            6'b001001: o_opcodeAlu = {N_OPCODE{1'b1}}; // JALR -> Invalid input for the ALU
